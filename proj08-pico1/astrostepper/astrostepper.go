...
type RADriver struct {
	...
	//   -------------  ----------------  -----------------  -----------  ---------------------------
	//        1           1 (full)          16     (1*16/1)       6912        0.900  (  0h, 54m, 0s)
	//        2           1 (full)          32     (2*16/1)      13824        1.800  (  1h, 48m, 0s)
	//        3           1 (full)          48     (3*16/1)      20736        2.700  (  2h, 42m, 0s)
	//      400						1 (full)        6400   (400*16/1)    2764800      360.000  (360h, 54m, 0s)
	//      ...
	//        1           2 (half)           8     (1*16/2)       3456        0.450
	//        2           2 (half)          16     (2*16/2)       6912        0.900
	//        3           2 (half)          24     (3*16/2)      10368        1.350
	//      800           2 (half)        6400   (800*16/2)    2764800      360.000
	//      ...
	//        1           4 (quarter)        4     (1*16/4)       1728        0.225
	//        2           4 (quarter)        8     (2*16/4)       3456        0.450
	//        3           4 (quarter)       12     (3*16/4)       5185        0.675
	//     1600           4 (quarter)     6400  (1600*16/4)    2764800      360.000
	//      ...
	//        1           8 (eight)          2     (1*16/8)        864        0.112
	//        2           8 (eight)          4     (2*16/8)       1728        0.225
	//        3           8 (eight)          6     (3*16/8)       2592        0.337
	//     3200           8 (eight)       6400  (3200*16/8)    2764800      360.000
	//      ...
	//        1          16 (sixteenth)      1    (1*16/16)        432        0.056
	//        2          16 (sixteenth)      2    (2*16/16)        864        0.112
	//        3          16 (sixteenth)      3    (3*16/16)       1296        0.168
	//     6400          16 (sixteenth)   6400 (6400*16/16)    2764800      360.000
	//
